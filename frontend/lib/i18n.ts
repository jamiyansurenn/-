...
export const translations = {
  mn: {
    nav: {
      ...
      constructionProjects: 'Хэрэгжиж буй төслүүд',
      constructionNews: 'Хийсэн ажлууд',
      news: 'Мэдээ',
      hr: 'Хүний нөөц',
      hrJobs: 'Ажлын байр',
  ...
  en: {
    nav: {
      ...
      constructionProjects: 'Projects in progress',
      constructionNews: 'Completed projects',
      news: 'News',
      hr: 'Human Resources',
      hrJobs: 'Job Openings',
  ...
  zh: {
    nav: {
      ...
      aboutDirector: '董事致辞',
      construction: '建设',
      constructionProjects: '在建项目',
      constructionNews: '已完成工程',
      news: '新闻',
      hr: '人力资源',
      hrJobs: '职位空缺',
      hrApplication: '工作申请',
  ...
  ru: {
    nav: {
      ...
      constructionProjects: 'Проекты в работе',
      constructionNews: 'Завершённые работы',
      news: 'Новости',
      hr: 'Отдел кадров',
      hrJobs: 'Вакансии',
  ...
  ja: {
    nav: {
      ...
      construction: '建設',
      constructionProjects: '進行中のプロジェクト',
      constructionNews: '完了した工事',
      news: 'ニュース',
      hr: '人事',
      hrJobs: '求人',
      hrApplication: '求人応募',
  ...
  ko: {
    nav: {
      ...
      construction: '건설',
      constructionProjects: '진행 중인 프로젝트',
      constructionNews: '완료 공사',
      news: '뉴스',
      hr: '인재채용',
      hrJobs: '채용 공고',
      hrApplication: '입사 지원',
