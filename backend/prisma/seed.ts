...
Амралтын газар — Завхан аймаг, Тосонцэнгэл сумд байрладаг.`;
  ...
  const companyMission = `Аюулгүй ажиллагаа, чанар, хугацааны төлөвлөгөөг эрхэмлэн харилцагчдад найдвартай, урт настай бүтээгдэхүүн, үйлчилгээг хүргэх. Дэвшилтэт шийдэл, ёс зүйтэй харилцааар түншлэлээ бэхжүүлнэ.`;

  const companyValues = `Чанар, стандарт — салбарын шаардлагыг чанд мөрдөнө.
